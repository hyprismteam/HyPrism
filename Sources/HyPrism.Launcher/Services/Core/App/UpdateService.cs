...
public class UpdateService : IUpdateService
{
    ...
    private readonly IGameVersionCatalog _versionService;
    ...
    public UpdateService(
        ...
        IConfigStore configService,
        IGameVersionCatalog versionService,
        IInstanceRepository instanceService,
    ...
    private string GetLatestInstancePath()
    {
        ...
        var branch = LauncherUtilities.NormalizeVersionType(_config.VersionType);
    ...
    public async Task<bool> DuplicateLatestAsync(string branch)
    {
        try
        {
            ...
            LauncherUtilities.CopyDirectory(latestPath, versionedPath);
