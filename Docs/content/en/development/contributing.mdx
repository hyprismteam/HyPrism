...
5. Run the relevant [test suite](/docs/development/testing)
...
Use [GitHub issue templates](https://github.com/hyprismteam/HyPrism/issues/new/choose). Include platform, launcher version, reproduction steps, expected and actual behavior, and relevant [logs](/docs/architecture/data-and-cache)
