...
The documentation is a Docusaurus 3 application under `Docs`. Use Node.js 22 and the pnpm version pinned in `Docs/package.json`
...
`pnpm check` validates prose, language parity, code fences, local images, internal routes, explicit bilingual anchors, repository links, and Core contract documentation, then runs TypeScript checks. The static export goes to `Docs/out`
