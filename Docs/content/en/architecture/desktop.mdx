...
The shared vertical scrollbar keeps a fixed 6 px thumb layout slot. Its idle 3 px appearance and expanded 6 px appearance use a `RenderTransform` transition, so hover changes do not trigger repeated measure and arrange passes. Keep future thickness animations on render properties rather than `Width`
