...
Official profiles always use official authentication. Local Node chooses a free port from `8443–9999` on `127.0.0.1`; neither the address nor its per-launch port is stored in this file
...
| `BackgroundMode` | `auto` | Rotation or bundled image filename |
